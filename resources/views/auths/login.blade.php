            ...
            <form class="user" action="/postlogin" method="POST">
              ...
              <div class="p-5">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" value="" id="exampleInputusernameid" name="id" placeholder="User ID">
                </div>
                <div class="form-group">
                  <input type="password" class="form-control form-control-user" value="" id="exampleInputPassword" name="password" placeholder="Password">
                </div>
                <input type="submit" value="LOGIN" class="btn btn-primary btn-user btn-block" name="submit">

                <hr>
                <div class="text-center">
                  <a class="small" href="{{ route('admin-register') }}">Admin Register</a>
                </div>
              </div>
            </form>
          </div>
